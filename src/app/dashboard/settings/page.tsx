...
export default function AccountSettingsPage() {
  ...
  useEffect(() => {
    ...
    // Load user sessions and security settings
  ...
  const handleDataExport = async () => {
    ...
    try {
      ...
      a.href = url
      a.download = `patternsight-data-${new Date().toISOString().split('T')[0]}.json`
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-xl font-bold text-white">Account Settings</span>
            </div>
                ...
                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <button
                      ...
                      className="bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 disabled:from-gray-500 disabled:to-gray-600 text-indigo-900 font-bold py-2 px-4 rounded-lg transition-all disabled:cursor-not-allowed"
                    >
              ...
              >
                ...
                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
                  ...
                  <button
                    ...
                    className="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 disabled:from-gray-500 disabled:to-gray-600 text-white font-bold py-2 px-4 rounded-lg transition-all disabled:cursor-not-allowed flex items-center space-x-2"
                  >
                    {dataExportLoading ? (
                      <>
                ...
                <div className="space-y-6">
                  ...
                  <div className="border border-red-500/30 rounded-lg p-4">
                    ...
                    <button
                      ...
                      disabled={loading}
                      className="bg-red-500 hover:bg-red-600 disabled:bg-gray-500 text-white font-bold py-2 px-4 rounded-lg transition-all disabled:cursor-not-allowed flex items-center space-x-2"
                    >
